...
@Root(name = "DicResult")
class DicResult {
    @get:Attribute(name = "nmt_code", required = false)
    @set:Attribute(name = "nmt_code", required = false)
    var nmtCode: String? = null

    @get:Attribute(name = "code", required = false)
    @set:Attribute(name = "code", required = false)
...
class Syn {
    ...
    @set:Attribute(name = "pos", required = false)
    var pos: String? = null
    @get:Attribute(name = "fr", required = false)
    @set:Attribute(name = "fr", required = false)
    var fr: String? = null
    @get:Element(name = "text", required = false)
    @set:Element(name = "text", required = false)
    var text: String? = null
